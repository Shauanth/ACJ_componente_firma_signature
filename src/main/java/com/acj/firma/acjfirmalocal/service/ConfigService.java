 ...
 * recompilar, en %LOCALAPPDATA%\ACJ-Firma-Digital\config.properties. Si no existe,
...
public class ConfigService {
    ...
    private static final String KEY_APUSIGN_BACKEND_URL = "apusign.backend.url";
    ...
    private static final String DEFAULT_APUSIGN_BACKEND_URL = "http://localhost:8081/asc-apusign-security/v1";
    ...
    public static synchronized String getApusignBackendUrl() {
        cargarSiHaceFalta();
        return properties.getProperty(KEY_APUSIGN_BACKEND_URL, DEFAULT_APUSIGN_BACKEND_URL);
    }
    ...
    private static File getConfigFile() {
        ...
        File dir = localAppData != null
                ? new File(localAppData, "ACJ-Firma-Digital")
                : new File(System.getProperty("user.home"), ".acj-firma-digital");
    ...
    private static void cargarSiHaceFalta() {
        ...
        properties.setProperty(KEY_APUSIGN_BACKEND_URL, DEFAULT_APUSIGN_BACKEND_URL);
    ...
    private static void crearArchivoConDefaults(File configFile) {
        try {
            ...
            try (FileOutputStream out = new FileOutputStream(configFile)) {
                properties.store(out, "Configuracion de backends de ACJ Firma Digital. Editar y reiniciar el agente para aplicar cambios.");
            }
